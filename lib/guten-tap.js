import { openBlock as V, createElementBlock as ne, normalizeClass as jt, renderSlot as Zl, createVNode as Pe, Transition as Vf, withCtx as be, createCommentVNode as it, defineComponent as Kr, ref as ll, onMounted as nd, onBeforeUnmount as al, h as er, markRaw as rd, getCurrentInstance as Ff, watchEffect as $f, nextTick as jf, unref as Wf, reactive as _f, render as ea, customRef as Kf, Fragment as Ct, renderList as St, withModifiers as pe, createElementVNode as je, createTextVNode as qf, toDisplayString as Uf, resolveComponent as ar, createBlock as Qe, createSlots as Jf, withKeys as Gf } from "vue";
const qr = (n, e) => {
...
const Zf = /* @__PURE__ */ qr(Yf, [["render", Qf]]);
const eh = {
  computed: {
    hasDropdown() {
...
}, th = { class: "tw-group tw-text-sm tw-relative" };
function nh(n, e, t, r, i, o) {
  return V(), ne("div", th, [
    Zl(n.$slots, "default"),
    Pe(Vf, { name: "dropdown" }, {
      default: be(() => [
        o.hasDropdown && t.dropDownActive ? (V(), ne("div", {
          key: 0,
          class: jt(["tw-z-10 tw-bg-white tw-shadow tw-py-2 tw-group-focus-within:block tw-overflow-hidden tw-whitespace-nowrap tw-absolute tw-bottom-full sm:tw-bottom-auto sm:tw-top-full tw-mt-4 tw-rounded tw-border tw-border-slate-400", t.align === "left" ? "tw-left-0" : "tw-right-0"])
        }, [
          Zl(n.$slots, "dropdown")
        ], 2)) : it("", !0)
      ]),
...
const rh = /* @__PURE__ */ qr(eh, [["render", nh]]), ih = {
  props: {
    content: {
      type: String,
      required: !1
...
}, oh = ["aria-label", "title", "innerHTML"];
function sh(n, e, t, r, i, o) {
  return V(), ne("button", {
...
const lh = /* @__PURE__ */ qr(ih, [["render", sh]]);
function me(n) {
  this.content = n;
}
me.prototype = {
...
const uh = 12, ta = /* @__PURE__ */ new WeakMap();
class Bi {
  /**
...
let qt = class Ss {
  ...
  */
  hasMarkup(e, t, r) {
    return this.type == e && Ii(this.attrs, t || e.defaultAttrs || fh) && q.sameSet(this.marks, r || q.none);
  }
  /**
  ...
  */
  replace(e, t, r) {
    return ah(this.resolve(e), this.resolve(t), r);
  }
  /**
...
class Ch {
  constructor(e, t, r) {
    this.hasDefault = Object.prototype.hasOwnProperty.call(r, "default"), this.default = r.default, this.validate = typeof r.validate == "string" ? xh(e, t, r.validate) : r.validate;
  }
  get isRequired() {
...
class vd {
  ...
  */
  constructor(e) {
    ...
    for (let i in e)
      t[i] = e[i];
    t.nodes = me.from(e.nodes), t.marks = me.from(e.marks || {}), this.nodes = ia.compile(this.spec.nodes, this), this.marks = So.compile(this.spec.marks, this);
    let r = /* @__PURE__ */ Object.create(null);
  ...
  */
  matchTag(e, t, r) {
    for (let i = r ? this.tags.indexOf(r) + 1 : 0; i < this.tags.length; i++) {
      let o = this.tags[i];
      if (Eh(e, o.tag) && (o.namespace === void 0 || e.namespaceURI == o.namespace) && (!o.context || t.matchesContext(o.context))) {
        if (o.getAttrs) {
          let s = o.getAttrs(e);
          if (s === !1)
            continue;
...
function Oh(n) {
  let e = ua.get(n);
  return e === void 0 && ua.set(n, e = Nh(n)), e;
}
function Nh(n) {
  let e = null;
  function t(r) {
  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= u) {
        ...
        if (r)
          return h;
        let p = e == (t < 0 ? a : u) ? null : Dh(l / 3, e - a), g = e == a ? Md : e == u ? Sd : Ti;
...
function Fh(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (s, l) => {
    ...
    if (s.isTextblock && !s.hasMarkup(r, a) && $h(n.doc, n.mapping.slice(o).map(l), r)) {
      let c = null;
...
function To(n, e, t = e, r = T.empty) {
  ...
  return Dd(i, o, r) ? new ae(e, t, r) : new Uh(i, o, r).fit();
}
function Dd(n, e, t) {
...
class Go {
  constructor(e, t) {
    this.schema = e, this.plugins = [], this.pluginsByKey = /* @__PURE__ */ Object.create(null), this.fields = tp.slice(), t && t.forEach((r) => {
...
function ba(n, e, t, r, i) {
  for (; ; ) {
    ...
    if (e == (i < 0 ? 0 : Ke(n))) {
      let o = n.parentNode;
      if (!o || o.nodeType != 1 || Ur(n) || rp.test(n.nodeName) || n.contentEditable == "false")
        return !1;
      e = ge(n) + (i < 0 ? 0 : 1), n = o;
...
const Ns = !De && /Chrome\/(\d+)/.exec(en), xe = !!Ns, Vd = Ns ? +Ns[1] : 0, Te = !De && !!ut && /Apple Computer/.test(ut.vendor), Un = Te && (/Mobile\/\w+/.test(en) || !!ut && ut.maxTouchPoints > 2), _e = Un || (ut ? /Mac/.test(ut.platform) : !1), cp = ut ? /Win/.test(ut.platform) : !1, Ze = /Android \d/.test(en), Jr = !!ka && "webkitFontSmoothing" in ka.documentElement.style, dp = Jr ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function up(n) {
...
function xa(n, e, t) {
  ...
  for (let s = t || n.dom; s; s = Rr(s)) {
    if (s.nodeType != 1)
      continue;
    let l = s, a = l == o.body, c = a ? up(o) : fp(l), d = 0, u = 0;
...
function pp({ refDOM: n, refTop: e, stack: t }) {
...
function jd(n, e) {
  ...
  return !t && a && (t = a, i = c, r = 0), t && t.nodeType == 3 ? gp(t, i) : !t || r && t.nodeType == 1 ? { node: n, offset: o } : jd(t, i);
}
function gp(n, e) {
...
function bp(n, e) {
  let t = n.dom.ownerDocument, r, i = 0, o = ap(t, e.left, e.top);
  o && ({ node: r, offset: i } = o);
  ...
  if (s = yp(s, e), r) {
    ...
    let c;
    Jr && i && r.nodeType == 1 && (c = r.childNodes[i - 1]).nodeType == 1 && c.contentEditable == "false" && c.getBoundingClientRect().top >= e.top && i--, r == n.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? l = n.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (l = vp(n, r, i, e));
  }
  l == null && (l = wp(n, s, e));
...
function _d(n, e, t) {
  ...
  if (r.nodeType == 3)
    if (s && (kp.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let a = Pt(At(r, i, i), t);
...
function Sp(n, e, t) {
  ...
  return l ? !Cp.test(r.parent.textContent) || !l.modify ? t == "left" || t == "backward" ? o : s : Kd(n, e, () => {
...
function Mp(n, e, t) {
  return Sa == e && Ma == t ? Ta : (Sa = e, Ma = t, Ta = t == "up" || t == "down" ? xp(n, e, t) : Sp(n, e, t));
}
  ...
  domFromPos(e, t) {
    ...
    if (t <= 0) {
      ...
      for (; o = r ? this.children[r - 1] : null, !(!o || o.dom.parentNode == this.contentDOM); r--, s = !1)
        ;
      return o && t && s && !o.border && !o.domAtom ? o.domFromPos(o.size, t) : { node: this.contentDOM, offset: o ? ge(o.dom) + 1 : 0 };
    } else {
      let o, s = !0;
      for (; o = r < this.children.length ? this.children[r] : null, !(!o || o.dom.parentNode == this.contentDOM); r++, s = !1)
        ;
      return o && s && !o.border && !o.domAtom ? o.domFromPos(0, t) : { node: this.contentDOM, offset: o ? ge(o.dom) : this.contentDOM.childNodes.length };
    }
  }
...
class Gt extends Gr {
  ...
  static create(e, t, r, i, o, s) {
    ...
    let f = d;
    return d = Yd(d, r, t), c ? a = new Ap(e, t, r, i, d, u || null, f, c, o, s + 1) : t.isText ? new Oo(e, t, r, i, d, f, o) : new Gt(e, t, r, i, d, u || null, f, o, s + 1);
  }
  parseRule() {
  ...
  // `this.children`.
  updateChildren(e, t) {
    let r = this.node.inlineContent, i = t, o = e.composing ? this.localCompositionInfo(e, t) : null, s = o && o.pos > -1 ? o : null, l = o && o.pos < 0, a = new Op(this, s && s.node, e);
    Rp(this.node, this.innerDeco, (c, d, u) => {
    ...
    }), a.syncToMarks([], r, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == dn) && (s && this.protectLocalComposition(e, s), Jd(this.contentDOM, this.children, e), Un && Ip(this.dom));
  }
...
class Op {
  ...
  addTextblockHacks() {
    ...
    (!e || // Empty textblock
    !(e instanceof Oo) || /\n$/.test(e.node.text) || this.view.requiresGeckoHackNode && /\s$/.test(e.node.text)) && ((Te || xe) && e && e.dom.contentEditable == "false" && this.addHackNode("IMG", t), this.addHackNode("BR", this.top));
  }
  addHackNode(e, t) {
...
function ml(n, e = null) {
  ...
  if (Eo(t)) {
    for (a = s; i && !i.node; )
      i = i.parent;
    let u = i.node;
    if (i && u.isAtom && R.isSelectable(u) && i.parent && !(u.isInline && sp(t.focusNode, t.focusOffset, i.dom))) {
      let f = i.posBefore;
...
function Nt(n, e = !1) {
  ...
  if (Qd(n, t), !!Xd(n)) {
    ...
    if (n.domObserver.disconnectSelection(), n.cursorWrapper)
      ...
      Na && !(t instanceof D) && (t.$from.parent.inlineContent || (o = Da(n, t.from)), !t.empty && !t.$from.parent.inlineContent && (s = Da(n, t.to))), n.docView.setSelection(r, i, n, e), Na && (o && Ra(o), s && Ra(s)), t.visible ? n.dom.classList.remove("ProseMirror-hideselection") : (n.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && Pp(n));
    }
    n.domObserver.setCurSelection(), n.domObserver.connectSelection();
  }
}
const Na = Te || xe && Vd < 63;
function Da(n, e) {
...
function Bp(n) {
  ...
  i ? t.setStart(r.parentNode, ge(r) + 1) : t.setStart(r, 0), t.collapse(!0), e.removeAllRanges(), e.addRange(t), !i && !n.state.selection.visible && De && Jt <= 11 && (r.disabled = !0, r.disabled = !1);
}
function Qd(n, e) {
  if (e instanceof R) {
  ...
  for (nt && t.nodeType == 1 && r < $i(t) && br(t.childNodes[r], -1) && (s = !0); ; )
    if (r > 0) {
        ...
        break;
      {
        ...
        for (; l && br(l, -1); )
          i = t.parentNode, o = ge(l), l = l.previousSibling;
        if (l)
          t = l, r = $i(t);
        else {
  ...
  for (; ; )
    if (r < i) {
        ...
        break;
      {
        let l = t.nextSibling;
        for (; l && br(l, 1); )
          o = l.parentNode, s = ge(l) + 1, l = l.nextSibling;
        if (l)
          t = l, r = 0, i = $i(t);
        else {
          if (t = t.parentNode, t == n.dom)
...
function Ls(n, e, t) {
  if (e.nodeType != 3) {
    let o, s;
    (s = Fp(e, t)) ? (e = s, t = 0) : (o = $p(e, t)) && (e = o, t = o.nodeValue.length);
  }
...
function Ba(n, e) {
  ...
  if (!(xe || cp) && t.parent.inlineContent) {
...
`))), 0, 0) : T.empty;
  ...
  if (l || (l = (n.someProp("clipboardParser") || n.someProp("domParser") || Ut.fromSchema(n.state.schema)).parseSlice(s, {
    ...
    l = Yp(Fa(l, +d[1], +d[2]), d[4]);
  else if (l = T.maxOpen(qp(l.content, i), !0), l.openStart || l.openEnd) {
    let u = 0, f = 0;
...
function Jp(n) {
  ...
  if ((i = r && su[r[1].toLowerCase()]) && (n = i.map((o) => "<" + o + ">").join("") + n + i.map((o) => "</" + o + ">").reverse().join("")), t.innerHTML = Up(n), i)
    for (let o = 0; o < i.length; o++)
...
const Ae = {}, Ee = {}, Xp = { touchstart: !0, touchmove: !0 };
class Qp {
  constructor() {
...
function Zp(n) {
  for (let e in Ae) {
    ...
    n.dom.addEventListener(e, n.input.eventHandlers[e] = (r) => {
      tm(n, r) && !yl(n, r) && (n.editable || !(r.type in Ee)) && t(n, r);
...
Ee.keydown = (n, e) => {
  let t = e;
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !cu(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(Ze && xe && t.keyCode == 13)))
    if (t.keyCode != 229 && n.domObserver.forceFlush(), Un && t.keyCode == 13 && !t.ctrlKey && !t.altKey && !t.metaKey) {
      ...
      n.someProp("handleKeyDown", (r) => r(n, t)) || _p(n, t) ? t.preventDefault() : Kt(n, "key");
};
Ee.keyup = (n, e) => {
...
function sm(n, e, t, r, i) {
  return wl(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (o) => o(n, e, r)) || (i ? om(n, t) : im(n, t));
}
function lm(n, e, t, r) {
  return wl(n, "handleDoubleClickOn", e, t, r) || n.someProp("handleDoubleClick", (i) => i(n, e, r));
}
function am(n, e, t, r) {
  return wl(n, "handleTripleClickOn", e, t, r) || n.someProp("handleTripleClick", (i) => i(n, e, r)) || cm(n, t, r);
}
function cm(n, e, t) {
  if (t.button != 0)
    return !1;
...
Ae.mousedown = (n, e) => {
  ...
  i - n.input.lastClick.time < 500 && rm(t, n.input.lastClick) && !t[au] && (n.input.lastClick.type == "singleClick" ? o = "doubleClick" : n.input.lastClick.type == "doubleClick" && (o = "tripleClick")), n.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: o };
  let s = n.posAtCoords(No(t));
  s && (o == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new dm(n, s, t, !!r)) : (o == "doubleClick" ? lm : am)(n, s.pos, s.inside, t) ? t.preventDefault() : Kt(n, "pointer"));
};
class dm {
  constructor(e, t, r, i) {
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(No(e))), this.updateAllowDefault(e), this.allowDefault || !t ? Kt(this.view, "pointer") : sm(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
    ...
    // works around that.
    xe && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (_n(this.view, I.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault()) : Kt(this.view, "pointer");
  }
  move(e) {
...
function uu(n) {
  for (n.composing && (n.input.composing = !1, n.input.compositionEndedAt = hm()); n.input.compositionNodes.length > 0; )
...
function fm(n) {
  ...
  if (!e.focusNode)
    return null;
  let t = ip(e.focusNode, e.focusOffset), r = op(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
...
const Ir = De && Jt < 15 || Un && dp < 604;
Ae.copy = Ee.cut = (n, e) => {
  let t = e, r = n.state.selection, i = t.type == "cut";
  if (r.empty)
    return;
  let o = Ir ? null : t.clipboardData, s = r.content(), { dom: l, text: a } = tu(n, s);
  o ? (t.preventDefault(), o.clearData(), o.setData("text/html", l.innerHTML), o.setData("text/plain", a)) : pm(n, l), i && n.dispatch(n.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"));
};
function mm(n) {
...
function Lr(n, e, t, r, i) {
  ...
  if (!o)
    return !1;
  let s = mm(o), l = s ? n.state.tr.replaceSelectionWith(s, r) : n.state.tr.replaceSelection(o);
...
Ee.paste = (n, e) => {
  ...
  r && Lr(n, fu(r), r.getData("text/html"), i, t) ? t.preventDefault() : gm(n, t);
};
class hu {
  constructor(e, t, r) {
...
Ae.dragstart = (n, e) => {
  ...
  (!t.dataTransfer.files.length || !xe || Vd > 120) && t.dataTransfer.clearData(), t.dataTransfer.setData(Ir ? "Text" : "text/html", a.innerHTML), t.dataTransfer.effectAllowed = "copyMove", Ir || t.dataTransfer.setData("text/plain", c), n.dragging = new hu(d, !t[pu], s);
};
Ae.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
Ae.beforeinput = (n, e) => {
  if (xe && Ze && e.inputType == "deleteContentBackward") {
...
class ee {
  ...
  */
  static create(e, t) {
    return t.length ? _i(t, e, 0, mn) : ke;
  }
  /**
  ...
  */
  map(e, t, r) {
    return this == ke || e.maps.length == 0 ? this : this.mapInner(e, t, 0, 0, r || mn);
  }
  /**
  @internal
  */
  mapInner(e, t, r, i, o) {
    ...
    return this.children.length ? ym(this.children, s || [], e, t, r, i, o) : s ? new ee(s.sort(gn), Bn) : ke;
  }
  /**
  ...
  */
  add(e, t) {
    return t.length ? this == ke ? ee.create(e, t) : this.addInner(e, t, 0) : this;
  }
  addInner(e, t, r) {
    let i, o = 0;
    e.forEach((l, a) => {
  ...
  */
  ...
  removeInner(e, t) {
    ...
    return r == this.children && i == this.local ? this : i.length || r.length ? new ee(i, r) : ke;
  }
  forChild(e, t) {
    if (this == ke)
      return this;
...
class Vt {
  ...
  forChild(e, t) {
    ...
    for (let i = 0; i < this.members.length; i++) {
      ...
      o != ke && (o instanceof Vt ? r = r.concat(o.members) : r.push(o));
    }
    return Vt.from(r);
  }
  eq(e) {
...
function ym(n, e, t, r, i, o, s) {
  ...
  if (a) {
    let c = wm(l, n, e, t, i, o, s), d = _i(c, r, 0, s);
    e = d.local;
...
class xm {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new km(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
  ...
  flush() {
    ...
    if (nt && a.length) {
      ...
      if (d.length == 2) {
        ...
        for (let f of d) {
          let h = f.parentNode;
          h && h.nodeName == "LI" && (!u || Mm(e, u) != h) && f.remove();
        }
      }
    }
    let c = null;
    o < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && Eo(r) && (c = ml(e)) && c.eq(I.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, Nt(e), this.currentSelection.set(r), e.scrollToSelection()) : (o > -1 || i) && (o > -1 && (e.docView.markDirty(o, s), Cm(e)), this.handleDOMChange(o, s, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || Nt(e), this.currentSelection.set(r));
  }
  registerMutation(e, t) {
    ...
    if (e.type == "childList") {
      ...
      let s = i && i.parentNode == e.target ? ge(i) + 1 : 0, l = r.localPosFromDOM(e.target, s, -1), a = o && o.parentNode == e.target ? ge(o) : e.target.childNodes.length, c = r.localPosFromDOM(e.target, a, 1);
      return { from: l, to: c };
    } else
...
function Tm(n, e, t) {
  ...
  if (d && n.dom.contains(d.nodeType == 1 ? d : d.parentNode) && (c = [{ node: d, offset: a.anchorOffset }], Eo(a) || c.push({ node: a.focusNode, offset: a.focusOffset })), xe && n.input.lastKeyCode === 8)
    for (let m = o; m > i; m--) {
...
const Em = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function Om(n, e, t, r, i) {
  ...
  if (n.input.compositionPendingChanges = 0, e < 0) {
    ...
    if (P && !n.state.selection.eq(P)) {
      if (xe && Ze && n.input.lastKeyCode === 13 && Date.now() - 100 < n.input.lastKeyCodeTime && n.someProp("handleKeyDown", (j) => j(n, an(13, "Enter"))))
        return;
  ...
  let a = n.state.selection, c = Tm(n, e, t), d = n.state.doc, u = d.slice(c.from, c.to), f, h;
  n.input.lastKeyCode === 8 && Date.now() - 100 < n.input.lastKeyCodeTime ? (f = n.state.selection.to, h = "end") : (f = n.state.selection.from, h = "start"), n.input.lastKeyCode = null;
  let p = Rm(u.content, c.doc.content, c.from, f, h);
  if (p && n.input.domChangeCount++, (Un && n.input.lastIOSEnter > Date.now() - 225 || Ze) && i.some((A) => A.nodeType == 1 && !Em.test(A.nodeName)) && (!p || p.endA >= p.endB) && n.someProp("handleKeyDown", (A) => A(n, an(13, "Enter")))) {
  ...
  if (n.state.selection.anchor > p.start && Dm(d, p.start, p.endA, g, m) && n.someProp("handleKeyDown", (A) => A(n, an(8, "Backspace")))) {
    Ze && xe && n.domObserver.suppressSelectionUpdates();
    return;
  }
  xe && Ze && p.endB == p.start && (n.input.lastAndroidDelete = Date.now()), Ze && !v && g.start() != m.start() && m.parentOffset == 0 && g.depth == m.depth && c.sel && c.sel.anchor == c.sel.head && c.sel.head == p.endA && (p.endB -= 2, m = c.doc.resolveNoCache(p.endB - c.from), setTimeout(() => {
  ...
  if (v) {
    if (g.pos == m.pos)
      ...
      p.endA == p.endB && (L = Nm(g.parent.content.cut(g.parentOffset, m.parentOffset), y.parent.content.cut(y.parentOffset, p.endA - y.start())))
    )
  ...
  if (b || (b = n.state.tr.replace(w, C, c.doc.slice(p.start - c.from, p.endB - c.from))), c.sel) {
    ...
    A && !(xe && Ze && n.composing && A.empty && (p.start != p.endB || n.input.lastAndroidDelete < Date.now() - 100) && (A.head == w || A.head == b.mapping.map(C) - 1) || De && A.empty && A.head == w) && b.setSelection(A);
  }
...
class Im {
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    let f = d == "preserve" && s && this.dom.style.overflowAnchor == null && hp(this);
    if (s) {
      this.domObserver.stop();
      let h = u && (De || xe) && !this.composing && !i.selection.empty && !e.selection.empty && Lm(i.selection, e.selection);
      if (u) {
        let p = xe ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = fm(this)), (o || !this.docView.update(e.doc, c, a, this)) && (this.docView.updateOuterDeco(c), this.docView.destroy(), this.docView = Ea(e.doc, c, a, this.dom, this)), p && !this.trackWrites && (h = !0);
      }
      h || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && Hp(this)) ? Nt(this, h) : (Qd(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(i), !((r = this.dragging) === null || r === void 0) && r.node && !i.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, i), d == "reset" ? this.dom.scrollTop = 0 : d == "to selection" ? this.scrollToSelection() : f && pp(f);
  }
  /**
  @internal
  */
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && mp(this.dom), Nt(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (em(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], es(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, np());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return e ? Te && this.root.nodeType === 11 && lp(this.dom.ownerDocument) == this.dom && Sm(this, e) || e : { focusNode: null, focusOffset: 0, anchorNode: null, anchorOffset: 0 };
  }
  /**
  @internal
  */
...
var Xt = {
  ...
  221: "}",
  222: '"'
}, Bm = typeof navigator < "u" && /Mac/.test(navigator.platform), Hm = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var ye = 0; ye < 10; ye++)
  Xt[48 + ye] = Xt[96 + ye] = String(ye);
for (var ye = 1; ye <= 24; ye++)
  Xt[ye + 111] = "F" + ye;
for (var ye = 65; ye <= 90; ye++)
  Xt[ye] = String.fromCharCode(ye + 32), Ki[ye] = String.fromCharCode(ye);
for (var ns in Xt)
  Ki.hasOwnProperty(ns) || (Ki[ns] = Xt[ns]);
function zm(n) {
  var e = Bm && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || Hm && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? Ki : Xt)[n.keyCode] || n.key || "Unidentified";
...
function ag(n, e = null) {
  return function(t, r) {
    let { $from: i, $to: o } = t.selection, s = i.blockRange(o);
    if (!s)
      return !1;
    let l = r ? t.tr : null;
    return cg(l, s, n, e) ? (r && r(l.scrollIntoView()), !0) : !1;
  };
}
function cg(n, e, t, r = null) {
...
function ug(n) {
  return function(e, t) {
    ...
    return o ? t ? r.node(o.depth - 1).type == n ? fg(e, t, n, o) : hg(e, t, o) : !0 : !1;
  };
}
function fg(n, e, t, r) {
  ...
  return "style" in n ? n : {
    ...
    getAttrs: (t) => {
      ...
      const i = e.reduce((o, s) => {
        const l = s.attribute.parseHTML ? s.attribute.parseHTML(t) : yg(t.getAttribute(s.name));
        return l == null ? o : {
          ...o,
          [s.name]: l
        };
...
function tc(n) {
  return Object.fromEntries(
    // @ts-ignore
    Object.entries(n).filter(([e, t]) => e === "attrs" && gg(t) ? !1 : t != null)
  );
}
function wg(n, e) {
  var t;
...
function hi(n) {
  return xg(n) !== "Object" ? !1 : n.constructor === Object && Object.getPrototypeOf(n) === Object.prototype;
}
function Po(n, e) {
  const t = { ...n };
  ...
  return t.map((d) => new X({
    ...
    appendTransaction: (u, f, h) => {
      ...
      if (v) {
        ...
        const { from: b } = y, O = b + C.length, L = Tg(C);
        return a({
          rule: d,
          state: h,
          from: b,
...
class Fn {
  constructor(e, t) {
    this.splittableMarks = [], this.editor = t, this.extensions = Fn.resolve(e), this.schema = wg(this.extensions, t), this.setupExtensions();
  }
  /**
   ...
   */
  static resolve(e) {
    const t = Fn.sort(Fn.flatten(e)), r = Eg(t.map((i) => i.name));
...
}), !0), Dg = (n = !1) => ({ commands: e }) => e.setContent("", n), Rg = () => ({ state: n, tr: e, dispatch: t }) => {
...
}, Ig = (n) => (e) => n(e), Lg = () => ({ state: n, dispatch: e }) => tg(n, e), Pg = (n, e) => ({ editor: t, tr: r }) => {
...
}, Vg = () => ({ state: n, dispatch: e }) => Wm(n, e), Fg = () => ({ commands: n }) => n.keyboardShortcut("Enter"), $g = () => ({ state: n, dispatch: e }) => eg(n, e);
...
const _g = (n = null, e = {}) => ({ editor: t, view: r, tr: i, dispatch: o }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
...
}, Kg = (n, e) => (t) => n.every((r, i) => e(r, { ...t, index: i })), qg = (n, e) => ({ tr: t, commands: r }) => r.insertContentAt({ from: t.selection.from, to: t.selection.to }, n, e), Du = (n) => {
...
const Jg = (n) => !("type" in n), Gg = (n, e, t) => ({ tr: r, dispatch: i, editor: o }) => {
  var s;
  if (i) {
    t = {
    ...
    t.updateSelection && Ug(r, r.steps.length - 1, -1), t.applyInputRules && r.setMeta("applyInputRules", { from: a, text: h }), t.applyPasteRules && r.setMeta("applyPasteRules", { from: a, text: h });
  }
  return !0;
}, Yg = () => ({ state: n, dispatch: e }) => Ym(n, e), Xg = () => ({ state: n, dispatch: e }) => Xm(n, e), Qg = () => ({ state: n, dispatch: e }) => _m(n, e), Zg = () => ({ state: n, dispatch: e }) => Jm(n, e), e1 = () => ({ state: n, dispatch: e, tr: t }) => {
  try {
...
}, n1 = () => ({ state: n, dispatch: e }) => Km(n, e), r1 = () => ({ state: n, dispatch: e }) => qm(n, e);
function Ru() {
...
const o1 = (n) => ({ editor: e, view: t, tr: r, dispatch: i }) => {
  const o = i1(n).split(/-(?!$)/), s = o.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), l = new KeyboardEvent("keydown", {
    key: s === "Space" ? " " : s,
...
const s1 = (n, e = {}) => ({ state: t, dispatch: r }) => {
  const i = he(n, t.schema);
  return Br(t, i, e) ? Qm(t, r) : !1;
}, l1 = () => ({ state: n, dispatch: e }) => ng(n, e), a1 = (n) => ({ state: e, dispatch: t }) => {
  const r = he(n, e.schema);
  return ug(r)(e, t);
}, c1 = () => ({ state: n, dispatch: e }) => Zm(n, e);
function Bo(n, e) {
...
}, u1 = () => ({ tr: n, dispatch: e }) => (e && n.scrollIntoView(), !0), f1 = () => ({ tr: n, commands: e }) => e.setTextSelection({
  from: 0,
  to: n.doc.content.size
}), h1 = () => ({ state: n, dispatch: e }) => Um(n, e), p1 = () => ({ state: n, dispatch: e }) => Gm(n, e), m1 = () => ({ state: n, dispatch: e }) => rg(n, e), g1 = () => ({ state: n, dispatch: e }) => sg(n, e), y1 = () => ({ state: n, dispatch: e }) => og(n, e);
function zs(n, e, t = {}, r = {}) {
  return Ui(n, e, {
    slice: !1,
    parseOptions: t,
...
const w1 = (n, e = !1, t = {}, r = {}) => ({ editor: i, tr: o, dispatch: s, commands: l }) => {
  var a, c;
  const { doc: d } = o;
...
function Pu(n, e) {
  ...
  return t === "node" ? C1(n, e) : t === "mark" ? Iu(n, e) : {};
}
function S1(n, e = JSON.stringify) {
  const t = {};
  return n.filter((r) => {
    const i = e(r);
...
const O1 = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  ...
  return E1(r, t, a);
}, N1 = (n, e) => ({ tr: t }) => (t.setMeta(n, e), !0), D1 = (n, e = {}) => ({ state: t, dispatch: r, chain: i }) => {
...
const P1 = ({ keepMarks: n = !0 } = {}) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  ...
  if (!l.parent.isBlock)
    return !1;
  const u = a.parentOffset === a.parent.content.size, f = l.depth === 0 ? void 0 : b1(l.node(-1).contentMatchAt(l.indexAfter(-1)));
  let h = u && f ? [
    {
      type: f,
      attrs: d
  ...
  return p;
}, B1 = (n, e = {}) => ({ tr: t, state: r, dispatch: i, editor: o }) => {
  var s;
...
}, F1 = (n, e = {}) => ({ state: t, commands: r }) => {
  const i = he(n, t.schema);
  return Br(t, i, e) ? r.lift(i) : r.wrapIn(i, e);
}, $1 = () => ({ state: n, dispatch: e }) => {
  const t = n.plugins;
  for (let r = 0; r < t.length; r += 1) {
    const i = t[r];
    let o;
...
}, _1 = (n, e = {}) => ({ tr: t, state: r, dispatch: i }) => {
  let o = null, s = null;
  const l = Bo(typeof n == "string" ? n : n.name, r.schema);
  return l ? (l === "node" && (o = he(n, r.schema)), l === "mark" && (s = tn(n, r.schema)), i && t.selection.ranges.forEach((a) => {
...
var U1 = /* @__PURE__ */ Object.freeze({
  ...
  joinItemBackward: e1,
  joinItemForward: t1,
  joinTextblockBackward: n1,
  joinTextblockForward: r1,
  joinUp: Yg,
  keyboardShortcut: o1,
  lift: s1,
  liftEmptyBlock: l1,
  ...
  scrollIntoView: u1,
  selectAll: f1,
  selectNodeBackward: h1,
  selectNodeForward: p1,
  selectParentNode: m1,
  selectTextblockEnd: g1,
  selectTextblockStart: y1,
  setContent: w1,
  setMark: O1,
  setMeta: N1,
  setNode: D1,
...
let r0 = class extends mg {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = n0(t0, this.options.injectNonce));
  }
  /**
...
var Re = "top", Ge = "bottom", Ye = "right", Ie = "left", Rl = "auto", Yr = [Re, Ge, Ye, Ie], Gn = "start", zr = "end", l0 = "clippingParents", zu = "viewport", dr = "popper", a0 = "reference", lc = /* @__PURE__ */ Yr.reduce(function(n, e) {
  return n.concat([e + "-" + Gn, e + "-" + zr]);
}, []), Vu = /* @__PURE__ */ [].concat(Yr, [Rl]).reduce(function(n, e) {
  return n.concat([e, e + "-" + Gn, e + "-" + zr]);
}, []), c0 = "beforeRead", d0 = "read", u0 = "afterRead", f0 = "beforeMain", h0 = "main", p0 = "afterMain", m0 = "beforeWrite", g0 = "write", y0 = "afterWrite", w0 = [c0, d0, u0, f0, h0, p0, m0, g0, y0];
function ht(n) {
...
function Xn(n, e, t) {
  ...
  var s = Cn(n) ? Ve(n) : window, l = s.visualViewport, a = !$u() && t, c = (r.left + (a && l ? l.offsetLeft : 0)) / i, d = (r.top + (a && l ? l.offsetTop : 0)) / o, u = r.width / i, f = r.height / o;
  return {
    width: u,
    height: f,
    top: d,
...
function Xr(n) {
  for (var e = Ve(n), t = ac(n); t && k0(t) && Dt(t).position === "static"; )
    t = ac(t);
  return t && (ht(t) === "html" || ht(t) === "body" && Dt(t).position === "static") ? e : t || x0(n) || e;
}
function Pl(n) {
...
function M0(n) {
  ...
  if (!(!o || !s)) {
    var u = S0(i.padding, t), f = Ll(o), h = a === "y" ? Re : Ie, p = a === "y" ? Ge : Ye, g = t.rects.reference[d] + t.rects.reference[a] - s[a] - t.rects.popper[d], m = s[a] - t.rects.reference[a], y = Xr(o), v = y ? a === "y" ? y.clientHeight || 0 : y.clientWidth || 0 : 0, S = g / 2 - m / 2, w = u[h], C = v - f[d] - u[p], b = v / 2 - f[d] / 2 + S, O = kr(w, b, C), L = a;
...
function cc(n) {
  ...
  if (c) {
    ...
    if (b === Ve(t) && (b = nn(t), Dt(b).position !== "static" && l === "absolute" && (O = "scrollHeight", L = "scrollWidth")), b = b, i === Re || (i === Ie || i === Ye) && o === zr) {
      w = Ge;
...
function B0(n, e) {
  var t = Ve(n), r = nn(n), i = t.visualViewport, o = r.clientWidth, s = r.clientHeight, l = 0, a = 0;
  if (i) {
...
function xr(n, e) {
  var t;
  e === void 0 && (e = []);
  var r = qu(n), i = r === ((t = n.ownerDocument) == null ? void 0 : t.body), o = Ve(r), s = i ? [o].concat(o.visualViewport || [], zl(r) ? r : []) : r, l = e.concat(s);
  return i ? l : (
...
function uc(n, e, t) {
  return e === zu ? js(B0(n, t)) : Cn(e) ? z0(e, t) : js(H0(nn(n)));
}
function V0(n) {
...
function F0(n, e, t, r) {
  var i = e === "clippingParents" ? V0(n) : [].concat(e), o = [].concat(i, [t]), s = o[0], l = o.reduce(function(a, c) {
    var d = uc(n, c, r);
...
function Vr(n, e) {
  e === void 0 && (e = {});
  var t = e, r = t.placement, i = r === void 0 ? n.placement : r, o = t.strategy, s = o === void 0 ? n.strategy : o, l = t.boundary, a = l === void 0 ? l0 : l, c = t.rootBoundary, d = c === void 0 ? zu : c, u = t.elementContext, f = u === void 0 ? dr : u, h = t.altBoundary, p = h === void 0 ? !1 : h, g = t.padding, m = g === void 0 ? 0 : g, y = _u(typeof m != "number" ? m : Ku(m, Yr)), v = f === dr ? a0 : dr, S = n.rects.popper, w = n.elements[p ? v : f], C = F0(Cn(w) ? w : w.contextElement || nn(n.elements.popper), a, d, s), b = Xn(n.elements.reference), O = Uu({
    reference: b,
    element: S,
    strategy: "absolute",
    placement: i
...
function W0(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (var i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !0 : s, a = t.fallbackPlacements, c = t.padding, d = t.boundary, u = t.rootBoundary, f = t.altBoundary, h = t.flipVariations, p = h === void 0 ? !0 : h, g = t.allowedAutoPlacements, m = e.options.placement, y = dt(m), v = y === m, S = a || (v || !p ? [Ei(m)] : j0(m)), w = [m].concat(S).reduce(function(gt, Xe) {
      return gt.concat(dt(Xe) === Rl ? $0(e, {
        placement: Xe,
        boundary: d,
        rootBoundary: u,
        padding: c,
    ...
    if (L)
      for (var ve = p ? 3 : 1, mt = function(Xe) {
...
function Z0(n) {
  var e = n.state, t = n.options, r = n.name, i = t.mainAxis, o = i === void 0 ? !0 : i, s = t.altAxis, l = s === void 0 ? !1 : s, a = t.boundary, c = t.rootBoundary, d = t.altBoundary, u = t.padding, f = t.tether, h = f === void 0 ? !0 : f, p = t.tetherOffset, g = p === void 0 ? 0 : p, m = Vr(e, {
    ...
    padding: u,
    altBoundary: d
  }), y = dt(e.placement), v = Qn(e.placement), S = !v, w = Pl(y), C = Q0(w), b = e.modifiersData.popperOffsets, O = e.rects.reference, L = e.rects.popper, A = typeof g == "function" ? g(Object.assign({}, e.rects, {
    placement: e.placement
  })) : g, P = typeof A == "number" ? {
    mainAxis: A,
    altAxis: A
  ...
  if (b) {
    if (o) {
      var W, le = w === "y" ? Re : Ie, Q = w === "y" ? Ge : Ye, K = w === "y" ? "height" : "width", U = b[w], Z = U + m[le], Le = U - m[Q], ve = h ? -L[K] / 2 : 0, mt = v === Gn ? O[K] : L[K], Oe = v === Gn ? -L[K] : -O[K], rn = e.elements.arrow, gt = h && rn ? Ll(rn) : {
        width: 0,
        height: 0
      }, Xe = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : Wu(), yt = Xe[le], An = Xe[Q], wt = kr(0, O[K], gt[K]), En = S ? O[K] / 2 - ve - wt - yt - P.mainAxis : mt - wt - yt - P.mainAxis, Rt = S ? -O[K] / 2 + ve + wt + An + P.mainAxis : Oe + wt + An + P.mainAxis, On = e.elements.arrow && Xr(e.elements.arrow), Qr = On ? w === "y" ? On.clientTop || 0 : On.clientLeft || 0 : 0, rr = (W = F == null ? void 0 : F[w]) != null ? W : 0, Zr = U + En - rr - Qr, ei = U + Rt - rr, ir = kr(h ? Ji(Z, Zr) : Z, U, h ? yn(Le, ei) : Le);
      b[w] = ir, j[w] = ir - U;
    }
    if (l) {
      var or, ti = w === "x" ? Re : Ie, ni = w === "x" ? Ge : Ye, vt = b[C], It = C === "y" ? "height" : "width", sr = vt + m[ti], on = vt - m[ni], lr = [Re, Ie].indexOf(y) !== -1, ri = (or = F == null ? void 0 : F[C]) != null ? or : 0, ii = lr ? sr : vt - O[It] - L[It] - ri + P.altAxis, oi = lr ? vt + O[It] + L[It] - ri - P.altAxis : on, si = h && lr ? C0(ii, vt, oi) : kr(h ? ii : sr, vt, h ? oi : on);
      b[C] = si, j[C] = si - vt;
    }
    e.modifiersData[r] = j;
  }
...
function iy(n, e, t) {
  t === void 0 && (t = !1);
  var r = Ue(e), i = Ue(e) && ry(e), o = nn(e), s = Xn(n, i, t), l = {
    scrollLeft: 0,
    scrollTop: 0
  }, a = {
    x: 0,
  ...
  zl(o)) && (l = ny(e)), Ue(e) ? (a = Xn(e, !0), a.x += e.clientLeft, a.y += e.clientTop) : o && (a.x = Hl(o))), {
  ...
  return function(l, a, c) {
    ...
    var d = {
      ...
      setOptions: function(y) {
        ...
        var S = sy(ay([].concat(r, d.options.modifiers)));
      ...
      forceUpdate: function() {
        if (!f) {
          ...
          if (mc(v, S)) {
            d.rects = {
              reference: iy(v, Xr(S), d.options.strategy === "fixed"),
              popper: Ll(S)
...
var dy = [I0, X0, D0, Fu, G0, _0, ey, A0, q0], uy = /* @__PURE__ */ cy({
  defaultModifiers: dy
}), fy = "tippy-box", Ju = "tippy-content", hy = "tippy-backdrop", Gu = "tippy-arrow", Yu = "tippy-svg-arrow", ln = {
  passive: !0,
  capture: !0
}, Xu = function() {
...
function xy(n) {
  return Fr(n) ? [n] : vy(n) ? Gi(n) : Array.isArray(n) ? n : Gi(document.querySelectorAll(n));
}
function cs(n, e) {
...
function Sy(n, e) {
  ...
  return n.every(function(i) {
    var o = i.popperRect, s = i.popperState, l = i.props, a = l.interactiveBorder, c = wy(s.placement), d = s.modifiersData.offset;
    if (!d)
      return !0;
...
function Ay() {
  document.addEventListener("touchstart", My, ln), window.addEventListener("blur", Ty);
}
var Ey = typeof window < "u" && typeof document < "u", Oy = Ey ? (
  // @ts-ignore
  !!window.msCrypto
) : !1;
function Ln(n) {
...
var $r;
process.env.NODE_ENV !== "production" && Dy();
function Dy() {
  $r = /* @__PURE__ */ new Set();
}
function Et(n, e) {
...
var tf = {
  ...
  triggerTarget: null
}, tf, Iy), Ly = Object.keys(He), Py = function(e) {
...
function By(n, e) {
  var t = e ? Object.keys(nf(Object.assign({}, He, {
    plugins: e
  }))) : Ly, r = t.reduce(function(i, o) {
...
function Cc(n, e) {
  ...
  }, e.ignoreAttributes ? {} : By(n, e.plugins));
...
function rf(n, e) {
  ...
  var t = Object.keys(n);
  t.forEach(function(r) {
    var i = my(He, Object.keys(tf)), o = !py(i, r);
...
function Ks(n) {
  ...
  return {
    ...
    backdrop: t.find(function(r) {
      return r.classList.contains(hy);
    })
  };
}
function of(n) {
  var e = Cr(), t = Cr();
  t.className = fy, t.setAttribute("data-state", "hidden"), t.setAttribute("tabindex", "-1");
  var r = Cr();
...
var zy = 1, gi = [], us = [];
function Vy(n, e) {
  var t = Cc(n, Object.assign({}, He, nf(wc(e)))), r, i, o, s = !1, l = !1, a = !1, c = !1, d, u, f, h = [], p = gc(Zr, t.interactiveDebounce), g, m = zy++, y = null, v = yy(t.plugins), S = {
  ...
  return On(), ve(), U(), Z("onCreate", [w]), t.showOnCreate && sr(), b.addEventListener("mouseenter", function() {
  ...
  function le() {
    var k = W().parentNode;
    return k ? Cy(k) : document;
  }
  function Q() {
    return Ks(b);
  }
  function K(k) {
    return w.state.isMounted && !w.state.isVisible || at.isTouch || d && d.type === "focus" ? 0 : as(w.props.delay, k ? 0 : 1, He.delay);
  }
  function U(k) {
  ...
  function Le() {
    ...
    if (k.content) {
      ...
      _.forEach(function($) {
        var Me = $.getAttribute(N);
        if (w.state.isVisible)
          $.setAttribute(N, Me ? Me + " " + B : B);
        else {
          var Fe = Me && Me.replace(B, "").trim();
  ...
  function On() {
    F() && (Rt("touchstart", rr, {
      ...
      passive: !0
    })), gy(w.props.trigger).forEach(function(k) {
      if (k !== "manual")
        switch (Rt(k, rr), k) {
          case "mouseenter":
            Rt("mouseleave", ei);
  ...
  function rr(k) {
    ...
    if (!(!w.state.isEnabled || or(k) || l)) {
      ...
      d = k, g = k.currentTarget, ve(), !w.state.isVisible && by(k) && gi.forEach(function($) {
        return $(k);
  ...
  function Zr(k) {
    ...
    if (!(k.type === "mousemove" && B)) {
      var _ = It().concat(b).map(function($) {
        var Me, Fe = $._tippy, Nn = (Me = Fe.popperInstance) == null ? void 0 : Me.state;
        return Nn ? {
  ...
  function ti() {
    ni();
    var k = w.props, N = k.popperOptions, B = k.placement, _ = k.offset, $ = k.getReferenceClientRect, Me = k.moveTransition, Fe = j() ? Ks(b).arrow : null, Nn = $ ? {
    ...
    }), sn.push.apply(sn, (N == null ? void 0 : N.modifiers) || []), w.popperInstance = uy(Nn, b, Object.assign({}, N, {
      placement: B,
      onFirstUpdate: f,
      modifiers: sn
    }));
  ...
  function vt() {
    ...
    w.props.interactive && k === Xu || k === "parent" ? N = B.parentNode : N = Qu(k, [B]), N.contains(b) || N.appendChild(b), w.state.isMounted = !0, ti(), process.env.NODE_ENV !== "production" && Et(w.props.interactive && k === He.appendTo && B.nextElementSibling !== b, ["Interactive tippy element may not be accessible via keyboard", "navigation because it is not directly after the reference element", "in the DOM source order.", `
...
`, "See: https://atomiks.github.io/tippyjs/v6/accessibility/#interactivity"].join(" "));
  ...
  function oi(k) {
    if (process.env.NODE_ENV !== "production" && Et(w.state.isDestroyed, Ln("setProps")), !w.state.isDestroyed) {
      ...
      }) : B.triggerTarget && n.removeAttribute("aria-expanded"), ve(), U(), O && O(N, B), w.popperInstance && (ti(), It().forEach(function(_) {
  ...
  function If() {
    ...
    var k = w.state.isVisible, N = w.state.isDestroyed, B = !w.state.isEnabled, _ = at.isTouch && !w.props.touch, $ = as(w.props.duration, 0, He.duration);
    if (!(k || N || B || _) && !W().hasAttribute("disabled") && (Z("onShow", [w], !1), w.props.onShow(w) !== !1)) {
      if (w.state.isVisible = !0, j() && (b.style.visibility = "visible"), U(), Xe(), w.state.isMounted || (b.style.transition = "none"), j()) {
        var Me = Q(), Fe = Me.box, Nn = Me.content;
        cs([Fe, Nn], 0);
      }
      f = function() {
        var sn;
        if (!(!w.state.isVisible || c)) {
          ...
          Le(), ve(), yc(us, w), (sn = w.popperInstance) == null || sn.forceUpdate(), Z("onMount", [w]), w.props.animation && j() && wt($, function() {
  ...
  function Lf() {
    ...
    var k = !w.state.isVisible, N = w.state.isDestroyed, B = !w.state.isEnabled, _ = as(w.props.duration, 1, He.duration);
    if (!(k || N || B) && (Z("onHide", [w], !1), w.props.onHide(w) !== !1)) {
      if (w.state.isVisible = !1, w.state.isShown = !1, c = !1, s = !1, j() && (b.style.visibility = "hidden"), mt(), yt(), U(!0), j()) {
        var $ = Q(), Me = $.box, Fe = $.content;
        w.props.animation && (cs([Me, Fe], _), vc([Me, Fe], "hidden"));
      }
      Le(), ve(), w.props.animation ? j() && An(_, w.unmount) : w.unmount();
    }
  }
  function Pf(k) {
...
function Tn(n, e) {
  ...
  process.env.NODE_ENV !== "production" && (Ry(n), rf(e, t)), Ay();
...
const _y = Kr({
  ...
  setup(n) {
    ...
    return $f(() => {
      const r = n.editor;
      r && r.options.element && e.value && jf(() => {
...
class Ky {
  constructor(e, { props: t = {}, editor: r }) {
    this.editor = r, this.component = rd(e), this.el = document.createElement("div"), this.props = _f(t), this.renderedComponent = this.renderComponent();
  }
  get element() {
...
const qy = /^\s*>\s$/, af = de.create({
...
}), Uy = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, Jy = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, Gy = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, Yy = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, Xy = Je.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
...
}), Qy = "listItem", Ac = "textStyle", Ec = /^\s*([-+*])\s$/, Zy = de.create({
  name: "bulletList",
  addOptions() {
    return {
  ...
  addCommands() {
    return {
      toggleBulletList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Qy, this.editor.getAttributes(Ac)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
...
}), ew = new RegExp("(?<!`)`([^`]+)`(?!`)"), tw = new RegExp("(?<!`)`([^`]+)`(?!`)", "g"), nw = Je.create({
  name: "code",
  addOptions() {
    return {
      HTMLAttributes: {}
...
function fw() {
  return new X({
    props: {
      ...
      handleClick: pw,
      handleKeyDown: hw,
      handleDOMEvents: { beforeinput: mw }
    }
  });
}
const hw = xl({
...
function gw(n) {
  ...
  return e.className = "ProseMirror-gapcursor", ee.create(n.doc, [we.widget(n.selection.head, e, { key: "gapcursor" })]);
}
const yw = te.create({
  name: "gapCursor",
  addProseMirrorPlugins() {
...
class et {
  ...
  addTransform(e, t, r, i) {
    ...
    let c = s - r.depth;
    return c > Cw && (l = xw(l, c), s -= c), new et(l.append(o), s);
  }
  remapping(e, t) {
    let r = new $n();
  ...
  rebased(e, t) {
    ...
    return u.emptyItemCount() > kw && (u = u.compress(this.items.length - r.length)), u;
  }
  emptyItemCount() {
    let e = 0;
...
function Sw(n, e, t, r) {
  ...
  t.getMeta(Aw) && (n = new Ht(n.done, n.undone, null, 0, -1));
  ...
  if (t.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
    let l = t.getMeta("composition"), a = n.prevTime == 0 || !s && n.prevComposition != l && (n.prevTime < (t.time || 0) - r.newGroupDelay || !Mw(t, n.prevRanges)), c = s ? fs(n.prevRanges, t.mapping) : Oc(t.mapping.maps);
...
const wn = new se("history"), Aw = new se("closeHistory");
function Ew(n = {}) {
  return n = {
    depth: n.depth || 100,
...
const uf = df(!1, !0), ff = df(!0, !0), Ow = te.create({
  name: "history",
  addOptions() {
    return {
      depth: 100,
...
}), Dw = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, Rw = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, Iw = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, Lw = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, Pw = Je.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
...
}), Hw = "listItem", Dc = "textStyle", Rc = /^(\d+)\.\s$/, zw = de.create({
  name: "orderedList",
  addOptions() {
    return {
      itemTypeName: "listItem",
  ...
  addCommands() {
    return {
      toggleOrderedList: () => ({ commands: n, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Hw, this.editor.getAttributes(Dc)).run() : n.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
...
}), Fw = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, $w = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, jw = Je.create({
  name: "strike",
  addOptions() {
    return {
      HTMLAttributes: {}
  ...
  addExtensions() {
    ...
    const v = [];
    return this.options.bold !== !1 && v.push(Xy.configure((n = this.options) === null || n === void 0 ? void 0 : n.bold)), this.options.blockquote !== !1 && v.push(af.configure((e = this.options) === null || e === void 0 ? void 0 : e.blockquote)), this.options.bulletList !== !1 && v.push(Zy.configure((t = this.options) === null || t === void 0 ? void 0 : t.bulletList)), this.options.code !== !1 && v.push(nw.configure((r = this.options) === null || r === void 0 ? void 0 : r.code)), this.options.codeBlock !== !1 && v.push(ow.configure((i = this.options) === null || i === void 0 ? void 0 : i.codeBlock)), this.options.document !== !1 && v.push(sw.configure((o = this.options) === null || o === void 0 ? void 0 : o.document)), this.options.dropcursor !== !1 && v.push(cw.configure((s = this.options) === null || s === void 0 ? void 0 : s.dropcursor)), this.options.gapcursor !== !1 && v.push(yw.configure((l = this.options) === null || l === void 0 ? void 0 : l.gapcursor)), this.options.hardBreak !== !1 && v.push(ww.configure((a = this.options) === null || a === void 0 ? void 0 : a.hardBreak)), this.options.heading !== !1 && v.push(vw.configure((c = this.options) === null || c === void 0 ? void 0 : c.heading)), this.options.history !== !1 && v.push(Ow.configure((d = this.options) === null || d === void 0 ? void 0 : d.history)), this.options.horizontalRule !== !1 && v.push(Nw.configure((u = this.options) === null || u === void 0 ? void 0 : u.horizontalRule)), this.options.italic !== !1 && v.push(Pw.configure((f = this.options) === null || f === void 0 ? void 0 : f.italic)), this.options.listItem !== !1 && v.push(Bw.configure((h = this.options) === null || h === void 0 ? void 0 : h.listItem)), this.options.orderedList !== !1 && v.push(zw.configure((p = this.options) === null || p === void 0 ? void 0 : p.orderedList)), this.options.paragraph !== !1 && v.push(Vw.configure((g = this.options) === null || g === void 0 ? void 0 : g.paragraph)), this.options.strike !== !1 && v.push(jw.configure((m = this.options) === null || m === void 0 ? void 0 : m.strike)), this.options.text !== !1 && v.push(Ww.configure((y = this.options) === null || y === void 0 ? void 0 : y.text)), v;
  }
}), Kw = "ö", qw = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", Zn = (n, e) => {
  for (const t in e)
    n[t] = e[t];
  return n;
}, qs = "numeric", Us = "ascii", Js = "alpha", Sr = "asciinumeric", gr = "alphanumeric", Gs = "domain", hf = "emoji", Uw = "scheme", Jw = "slashscheme", ps = "whitespace";
function Gw(n, e) {
...
function Zw(n = []) {
  ...
  Ne.groups = e;
  const t = new Ne();
  wi == null && (wi = Pc(Kw)), vi == null && (vi = Pc(qw)), M(t, "'", Wl), M(t, "{", Mr), M(t, "}", Tr), M(t, "[", Xi), M(t, "]", Qi), M(t, "(", Zi), M(t, ")", eo), M(t, "<", to), M(t, ">", no), M(t, "（", ro), M(t, "）", io), M(t, "「", oo), M(t, "」", so), M(t, "『", lo), M(t, "』", ao), M(t, "＜", co), M(t, "＞", uo), M(t, "&", fo), M(t, "*", ho), M(t, "@", zt), M(t, "`", mo), M(t, "^", go), M(t, ":", Ft), M(t, ",", _l), M(t, "$", yo), M(t, ".", st), M(t, "=", wo), M(t, "!", Kl), M(t, "-", We), M(t, "%", Ar), M(t, "|", vo), M(t, "+", bo), M(t, "#", ko), M(t, "?", Er), M(t, '"', ql), M(t, "/", lt), M(t, ";", Ul), M(t, "~", Or), M(t, "_", xo), M(t, "\\", po), M(t, "・", gf);
  const r = re(t, xt, $l, {
    [qs]: !0
  });
  re(r, xt, r);
...
const iv = typeof console < "u" && console && console.warn || (() => {
}), ov = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", G = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function Vc(n, e = !1) {
  if (G.initialized && iv(`linkifyjs: already initialized - will not register custom scheme "${n}" ${ov}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(n))
...
function lv() {
  G.scanner = Zw(G.customSchemes);
  for (let n = 0; n < G.tokenQueue.length; n++)
    G.tokenQueue[n][1]({
      scanner: G.scanner
    });
  G.parser = nv(G.scanner.tokens);
...
function Gl(n) {
  return G.initialized || lv(), rv(G.parser.start, n, vf(G.scanner.start, n));
}
Gl.scan = vf;
...
function cv(n) {
  return new X({
    ...
    appendTransaction: (e, t, r) => {
      ...
      if (!i || o)
        return;
      const { tr: s } = r, l = v1(t.doc, [...e]);
      if (T1(l).forEach(({ newRange: c }) => {
        const d = k1(r.doc, c, (h) => h.isTextblock);
        let u, f;
...
function fr(n, e) {
  ...
  return e && e.forEach((r) => {
    ...
    i && t.push(i);
  }), !n || n.replace(fv, "").match(new RegExp(
...
const hv = Je.create({
  ...
  addProseMirrorPlugins() {
    ...
    return this.options.autolink && n.push(cv({
      type: this.type,
      defaultProtocol: this.options.defaultProtocol,
    ...
    })), this.options.openOnClick === !0 && n.push(dv({
      type: this.type
    })), this.options.linkOnPaste && n.push(uv({
      editor: this.editor,
      defaultProtocol: this.options.defaultProtocol,
      type: this.type
    })), n;
...
var J = class Tt extends I {
  ...
  getBookmark() {
    return new Cv(this.$anchorCell.pos, this.$headCell.pos);
  }
};
...
function Sv(n) {
  ...
  return n.selection.forEachCell((t, r) => {
    e.push(
      we.node(r, r + t.nodeSize, { class: "selectedCell" })
    );
  }), ee.create(n.doc, e);
}
...
function Av(n, e, t) {
  ...
  if (r instanceof R && (s = r.node.type.spec.tableRole)) {
    ...
    r instanceof D && Mv(r) ? o = D.create(i, r.from) : r instanceof D && Tv(r) && (o = D.create(i, r.$from.start(), r.$from.end()));
  return o && (e || (e = n.tr)).setSelection(o), e;
}
var Ev = new se("fix-tables");
function Mf(n, e, t, r) {
...
function Ov(n, e, t, r) {
  ...
  for (let a = 0, c = t + 1; a < i.height; a++) {
    ...
    if (f > 0) {
      ...
      const p = [];
      for (let m = 0; m < f; m++) {
        const y = Ce(n.schema)[h].createAndFill();
        y && p.push(y);
      }
  ...
  return r.setMeta(Ev, { fixTables: !0 });
}
function pt(n) {
...
function Af(n, { map: e, tableStart: t, table: r }, i) {
  ...
  for (let s = 0; s < e.height; s++) {
    ...
    if (i > 0 && i < e.width && e.map[l - 1] == e.map[l]) {
      ...
      const a = o == null ? Ce(r.type.schema).cell : r.nodeAt(e.map[l + o]).type, c = e.positionAt(s, i, r);
...
function Rv(n, { map: e, table: t, tableStart: r }, i) {
...
function Iv(n, e) {
  ...
  if (e) {
    ...
    if (t.left == 0 && t.right == t.map.width)
      return !1;
    for (let i = t.right - 1; Rv(r, t, i), i != t.left; i--) {
...
function Lv(n, e, t) {
  var r;
  const i = Ce(e.type.schema).header_cell;
...
function Ef(n, { map: e, tableStart: t, table: r }, i) {
  ...
  const l = [];
  let a = i > 0 ? -1 : 0;
  Lv(e, r, i + a) && (a = i == 0 || i == e.height ? null : 0);
  for (let c = 0, d = e.width * i; c < e.width; c++, d++)
    if (i > 0 && i < e.height && e.map[d] == e.map[d - e.width]) {
      ...
      const u = a == null ? Ce(r.type.schema).cell : (o = r.nodeAt(e.map[d + a * e.width])) == null ? void 0 : o.type, f = u == null ? void 0 : u.createAndFill();
      f && l.push(f);
    }
  return n.insert(s, Ce(r.type.schema).row.create(null, l)), n;
}
function Pv(n, e) {
  if (!rt(n))
    return !1;
...
function Hv(n, { map: e, table: t, tableStart: r }, i) {
  let o = 0;
  for (let c = 0; c < i; c++)
...
function zv(n, e) {
  ...
  if (e) {
    ...
    if (t.top == 0 && t.bottom == t.map.height)
      return !1;
    for (let i = t.bottom - 1; Hv(r, t, i), i != t.top; i--) {
      const o = t.tableStart ? r.doc.nodeAt(t.tableStart - 1) : r.doc;
      if (!o)
        throw RangeError("No table found");
...
function Vv({ width: n, height: e, map: t }, r) {
...
function jc(n, e) {
  const t = Ce(n.schema);
  return Fv(({ node: r }) => t[r.type.spec.tableRole])(n, e);
}
function Fv(n) {
  return (e, t) => {
    var r;
...
function jv(n) {
  return function(e, t) {
    if (!rt(e))
      return !1;
    if (t) {
      const r = Ce(e.schema), i = pt(e), o = e.tr, s = i.map.cellsInRect(
        n == "column" ? {
          left: i.left,
          top: 0,
          right: i.right,
...
function _r(n, e) {
  return e = e || { useDeprecatedLogic: !1 }, e.useDeprecatedLogic ? jv(n) : function(t, r) {
    if (!rt(t))
      return !1;
    if (r) {
      const i = Ce(t.schema), o = pt(t), s = t.tr, l = Wc("row", o, i), a = Wc(
        "column",
        o,
        i
...
function _c(n) {
  return function(e, t) {
    ...
    if (t) {
      ...
      t(
        e.tr.setSelection(D.between(i, kv(i))).scrollIntoView()
      );
    }
    return !0;
  };
...
function Uv(n, e) {
  ...
  for (let i = 0; i < t.length; i++)
    if (i >= e.length && e.push(x.empty), t[i] < r) {
      const o = Ce(n).cell.createAndFill(), s = [];
      for (let l = t[i]; l < r; l++)
        s.push(o);
...
function Jv({ width: n, height: e, rows: t }, r, i) {
  if (n != r) {
    const o = [], s = [];
...
function Uc(n, e, t, r, i) {
  ...
  Gv(u, s, o, t, c, d, f) && h(), Kc(u, s, o, t, a, c, l, f) && h(), Kc(u, s, o, t, a, c, d, f) && h(), qc(u, s, o, t, l, d, a, f) && h(), qc(u, s, o, t, l, d, c, f) && h();
  for (let p = l; p < d; p++) {
...
function Qv(n, e, t) {
  ...
  if (i instanceof J) {
    ...
    return r = Jv(r, l.right - l.left, l.bottom - l.top), Uc(n.state, n.dispatch, s, l, r), !0;
  } else if (r) {
...
function tb({
  ...
  const o = new X({
    ...
    state: {
      init(s, l) {
        var a, c;
        const d = (c = (a = o.spec) == null ? void 0 : a.props) == null ? void 0 : c.nodeViews, u = Ce(l.schema).table.name;
        return r && d && (d[u] = (f, h) => new r(f, t, h)), new nb(-1, !1);
      },
      apply(s, l) {
        return l.apply(s);
      }
...
function ob(n, e, t, r) {
  ...
  if (!s || s.activeHandle == -1 || s.dragging)
    return !1;
  const l = n.state.doc.nodeAt(s.activeHandle), a = sb(n, s.activeHandle, l.attrs);
  n.dispatch(
  ...
  function c(u) {
    ...
    const f = ze.getState(n.state);
    f != null && f.dragging && (ab(
      n,
      f.activeHandle,
      Yc(f.dragging, u, t)
    ), n.dispatch(
...
function sb(n, e, { colspan: t, colwidth: r }) {
...
function ab(n, e, t) {
  ...
  for (let c = 0; c < o.height; c++) {
    ...
    if (f.colwidth && f.colwidth[h] == t)
      continue;
    const p = f.colwidth ? f.colwidth.slice() : cb(f.colspan);
...
function db(n, e) {
  ...
  for (let c = 0; c < s.height; c++) {
    ...
    if ((a == s.width - 1 || s.map[d] != s.map[d + 1]) && (c == 0 || s.map[d] != s.map[d - s.width])) {
      ...
      h.className = "column-resize-handle", (t = ze.getState(n)) != null && t.dragging && r.push(
        we.node(
          l + u,
...
const Si = ({ editor: n }) => {
  ...
  renderHTML({ node: n, HTMLAttributes: e }) {
    const { colgroup: t, tableWidth: r, tableMinWidth: i } = hb(n, this.options.cellMinWidth);
    return [
      "table",
      Y(this.options.HTMLAttributes, e, {
  ...
  addCommands() {
    return {
      ...
      addColumnBefore: () => ({ state: n, dispatch: e }) => Nv(n, e),
      addColumnAfter: () => ({ state: n, dispatch: e }) => Dv(n, e),
      deleteColumn: () => ({ state: n, dispatch: e }) => Iv(n, e),
      addRowBefore: () => ({ state: n, dispatch: e }) => Pv(n, e),
      addRowAfter: () => ({ state: n, dispatch: e }) => Bv(n, e),
      deleteRow: () => ({ state: n, dispatch: e }) => zv(n, e),
      deleteTable: () => ({ state: n, dispatch: e }) => Kv(n, e),
      ...
      toggleHeaderCell: () => ({ state: n, dispatch: e }) => Wv(n, e),
      mergeOrSplit: () => ({ state: n, dispatch: e }) => $c(n, e) ? !0 : jc(n, e),
      setCellAttribute: (n, e) => ({ state: t, dispatch: r }) => $v(n, e)(t, r),
...
}), Sb = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/, Mb = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g, Tb = Je.create({
  name: "highlight",
  addOptions() {
    return {
      multicolor: !1,
...
}, Db = function({ view: n, dir: e, currentResolved: t }) {
  if (!t)
    return !1;
  let r = n.state.tr;
...
function Rf(n, e) {
  if (ks(n) && ks(e))
    for (const t in e)
      ks(e[t]) ? (n[t] || Object.assign(n, { [t]: {} }), Rf(n[t], e[t])) : Rb(e[t]) ? (n[t] || (n[t] = []), sl(n[t], e[t])) : Object.assign(n, { [t]: e[t] });
  return n;
}
const sl = function(n, e) {
...
}), Lb = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/, Pb = /^(https?:\/\/)?(www\.|music\.)?(youtube\.com|youtu\.be)(?!.*\/channel\/)(?!\/@)(.+)?$/g, Bb = (n) => n.match(Lb), ed = (n) => n ? "https://www.youtube-nocookie.com/embed/" : "https://www.youtube.com/embed/", Hb = (n) => {
  const {
    url: e,
    allowFullscreen: t,
    autoplay: r,
  ...
  addCommands() {
    return {
      setYoutubeVideo: (n) => ({ commands: e }) => Bb(n.src) ? e.insertContent({
        type: this.name,
        attrs: n
      }) : !1
    };
...
function jb(n) {
  var e;
  const { char: t, allowSpaces: r, allowedPrefixes: i, startOfLine: o, $position: s } = n, l = o0(t), a = new RegExp(`\\s${l}$`), c = o ? "^" : "", d = r ? new RegExp(`${c}${l}.*?(?=\\s${l}|$)`, "gm") : new RegExp(`${c}(?:^)?${l}[^\\s${l}]*`, "gm"), u = ((e = s.nodeBefore) === null || e === void 0 ? void 0 : e.isText) && s.nodeBefore.text;
  if (!u)
    return null;
...
const Wb = new se("suggestion");
function _b({ pluginKey: n = Wb, editor: e, char: t = "@", allowSpaces: r = !1, allowedPrefixes: i = [" "], startOfLine: o = !1, decorationTag: s = "span", decorationClass: l = "suggestion", command: a = () => null, items: c = () => [], render: d = () => ({}), allow: u = () => !0, findSuggestionMatch: f = jb }) {
  let h;
      ...
      return {
        update: async (m, y) => {
          ...
          h = {
            ...
            clientRect: Le ? () => {
              var ve;
              const { decorationId: mt } = (ve = this.key) === null || ve === void 0 ? void 0 : ve.getState(e.state), Oe = m.dom.querySelector(`[data-decoration-id="${mt}"]`);
...
}, Ub = { class: "tw-bg-white tw-border tw-border-slate-400 tw-rounded tw-overflow-hidden tw-shadow" }, Jb = ["onClick"], Gb = ["innerHTML"], Yb = {
  key: 1,
  class: "tw-p-2 tw-text-slate-600 tw-text-sm tw-w-full"
};
function Xb(n, e, t, r, i, o) {
  return V(), ne("div", Ub, [
    t.items.length ? (V(!0), ne(Ct, { key: 0 }, St(o.itemsWithInsertCommand, (s, l) => (V(), ne("button", {
      ...
      key: l,
      onClick: pe((a) => o.selectItem(l), ["prevent"])
    }, [
      je("span", {
        innerHTML: s.icon
      }, null, 8, Gb),
      qf(" " + Uf(s.title), 1)
    ], 10, Jb))), 128)) : (V(), ne("div", Yb, "No result"))
  ]);
}
const Qb = /* @__PURE__ */ qr(qb, [["render", Xb]]);
function Zb(n) {
  return {
...
const o2 = {
  ...
  data() {
    return {
      ...
      editor: null,
      allBlockTools: sl(e2(), this.blockTools),
      allInlineTools: sl(t2(), this.inlineTools),
      allAlignmentTools: this.alignmentTools.length ? this.alignmentTools : n2(),
      tableRowTools: r2(),
      tableColumnTools: i2(),
  ...
  created: function() {
    window.addEventListener("mousemove", () => this.cancelTyping()), this.closeAllDilogState();
  },
  unmounted: function() {
    window.removeEventListener("mousemove", () => this.cancelTyping()), this.closeAllDilogState();
  },
  mounted() {
    this.editor = new Wy({
      extensions: [
        ...
        Tb,
        Kb.configure({
          suggestion: Zb(this.allBlockTools)
        }),
        hv.configure({
          openOnClick: !1
        }),
  ...
  methods: {
    getDilogState(n) {
      return this.activeInlineDilog[n];
    },
    closeAllDilogState() {
      Object.keys(this.activeInlineDilog).forEach((e) => {
        this.activeInlineDilog[e] = 0;
      });
    },
    toggleDilaogState(n) {
      Object.keys(this.activeInlineDilog).forEach((t) => {
        t !== n && (this.activeInlineDilog[t] = 0);
      }), this.activeInlineDilog[n] === void 0 ? this.activeInlineDilog[n] = 1 : this.activeInlineDilog[n] = !this.activeInlineDilog[n];
    },
    cancelTyping() {
    ...
    tableIsActive() {
      return this.closeAllDilogState(), this.editable && this.getTopLevelNodeType() == "table";
    },
    moveNode(n = "UP") {
      Db({
        view: this.editor.view,
...
function g2(n, e, t, r, i, o) {
  ...
  return V(), ne("div", s2, [
    i.editor && i.tableRowTools ? (V(), Qe(c, {
      ...
      default: be(() => [
        Pe(a, {
          dropDownActive: o.getDilogState("row_tools")
        }, {
          dropdown: be(() => [
            (V(!0), ne(Ct, null, St(i.tableRowTools, (u) => (V(), Qe(l, {
              ...
              key: u.title,
              label: u.title,
              onClick: pe((f) => u.command(i.editor), ["prevent"])
            }, null, 8, ["innerHTML", "label", "onClick"]))), 128))
          ]),
          default: be(() => [
            Pe(s, {
              onClick: e[0] || (e[0] = pe(() => o.toggleDilaogState("row_tools"), ["prevent"])),
              title: "Row tools",
    ...
    i.editor && i.tableColumnTools ? (V(), Qe(c, {
      ...
      default: be(() => [
        Pe(a, {
          dropDownActive: o.getDilogState("column_tools")
        }, {
          dropdown: be(() => [
          ...
          default: be(() => [
            Pe(s, {
              ...
              content: i.moreIconRound,
              class: "tw-rounded-full tw-text-slate-400 hover:tw-text-slate-800",
              onClick: e[1] || (e[1] = pe(() => o.toggleDilaogState("column_tools"), ["prevent"]))
            }, null, 8, ["content"])
          ]),
          _: 1
        }, 8, ["dropDownActive"])
        ...
        return [
          je("div", l2, [
            je("button", {
              ...
              onMousedown: e[3] || (e[3] = (m) => o.startDragging(m)),
              onMouseup: e[4] || (e[4] = (m) => {
            ...
            !i.dragging && i.currentBlockTool ? (V(), ne("div", a2, [
              Pe(a, {
                dropDownActive: o.getDilogState("current_block_tool")
              }, Jf({
                default: be(() => {
                  var m, y, v;
                  return [
                    Pe(s, {
                      onClick: e[5] || (e[5] = pe(() => o.toggleDilaogState("current_block_tool"), ["prevent"])),
                ...
                (u = i.currentBlockTool) != null && u.canBeConverted ? {
                  name: "dropdown",
                  fn: be(() => [
                    e[14] || (e[14] = je("div", { class: "tw-p-3 tw-uppercase tw-text-gray-600 tw-text-xs tw-pb-1 tw-tracking-wide" }, " Transform to ", -1)),
                    (V(!0), ne(Ct, null, St(i.allBlockTools.filter(
                      ...
                      key: m.title,
                      label: m.title,
                      onClick: pe((y) => m.convertCommand(i.editor), ["prevent"]),
                      activeClass: "hidden",
            ...
            i.dragging ? it("", !0) : (V(), ne("div", c2, [
              je("button", {
                onClick: e[6] || (e[6] = pe((m) => o.moveNode("UP"), ["prevent"])),
              ...
              je("button", {
                onClick: e[7] || (e[7] = pe((m) => o.moveNode("DOWN"), ["prevent"])),
          ...
          i.dragging ? it("", !0) : (V(), ne("div", f2, [
            (V(!0), ne(Ct, null, St(o.activeAlignmentTools, (m, y) => (V(), Qe(a, {
              key: y,
              dropDownActive: o.getDilogState("tool_group_" + y)
            }, {
              dropdown: be(() => [
                (V(!0), ne(Ct, null, St(m, (v) => (V(), Qe(l, {
                  ...
                  label: v.title,
                  onClick: pe((S) => v.command(i.editor), ["prevent"]),
              ...
              default: be(() => {
                ...
                return [
                  Pe(s, {
                    onClick: pe(() => o.toggleDilaogState("tool_group_" + y), ["prevent"]),
                    title: (v = m.find(
              ...
              _: 2
            }, 1032, ["dropDownActive"]))), 128))
          ])),
          !i.dragging && ((h = (f = i.currentBlockTool) == null ? void 0 : f.tools) != null && h.length) ? (V(), ne("div", h2, [
            (V(!0), ne(Ct, null, St((p = i.currentBlockTool) == null ? void 0 : p.tools, (m) => {
              ...
              return V(), Qe(s, {
                ...
                onClick: pe((S) => m.command.call(0, i.editor), ["prevent"]),
          ...
          (g = i.currentBlockTool) != null && g.hasInlineTools && !i.dragging ? (V(), ne("div", p2, [
            (V(!0), ne(Ct, null, St(i.allInlineTools, (m, y) => (V(), Qe(a, {
              align: "right",
              key: m.title,
              dropDownActive: o.getDilogState("all_inline_tools_" + y)
            }, {
              dropdown: be(() => [
                (V(!0), ne(Ct, null, St(m.tools, (v) => (V(), Qe(l, {
                  key: v.name,
                  content: v.icon + " " + v.title,
                  onClick: pe((S) => v.command(i.editor), ["prevent"]),
              ...
              default: be(() => [
                Pe(s, {
                  ...
                  activeClass: m.isActiveClass,
                  onClick: pe(() => {
                    o.toggleDilaogState("all_inline_tools_" + y), m.command(i.editor);
                  }, ["prevent"]),
                  active: m.isActiveTest(i.editor)
          ...
          i.editor && i.editor.can().deleteNode(i.topLevelNodeType) && !i.dragging ? (V(), ne("div", m2, [
            Pe(a, {
              align: "right",
              dropDownActive: o.getDilogState("more_option")
            }, {
              dropdown: be(() => [
                Pe(l, {
                  ref: "deleteButton",
                  ...
                  label: "Delete block",
                  onClick: e[9] || (e[9] = pe((m) => o.deleteNode(i.topLevelNodeType), ["prevent"]))
                }, null, 8, ["content"])
              ]),
              default: be(() => [
                Pe(s, {
                  onClick: e[8] || (e[8] = pe(() => o.toggleDilaogState("more_option"), ["prevent"])),
                  content: i.moreIcon,
                  label: "More options"
                }, null, 8, ["content"])
              ]),
    ...
    Pe(d, {
      ...
      onKeyup: e[12] || (e[12] = Gf((u) => i.isTyping = !1, ["esc"])),
      ref: "editor",
      editor: i.editor
    }, null, 8, ["class", "editor"])
  ]);
}
const y2 = /* @__PURE__ */ qr(o2, [["render", g2]]), k2 = y2;
export {
  k2 as GutenTap
};
